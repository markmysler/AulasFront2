<template>
    <div class="columnItemsCenter w-100 py-5 ga-5">
        ...
        <v-form @submit.prevent="submitForm" class="columnItemsCenter w-100">
            <v-text-field class=" inputWidth" placeholder="Nombre de usuario"  v-model="username" />
            <v-text-field class=" inputWidth" placeholder="Email"  v-model="email" type="email" />
            <v-text-field 
                class=" inputWidth" 
            ...
            <div v-if="errors.length">
                <p v-for="error in errors" :key="error" class="text-center text-red" style="max-width: 60vw">
...
export default {
    ...
    data(){
        return{
            ...
            errors: [],
            errorMap: {
                'AxiosError: Request failed with status code 400': 'La contraseña debe tener al menos 8 caracteres e incluir mayusculas, minusculas y un numero o caracter especial/Un usuario con ese nombre o email ya existe',
