...
<div class="columnItemsCenter w-100 py-5 ga-5">
    ...
    <v-form @submit.prevent="submitForm" class="columnItemsCenter w-100">
        ...
        <div v-if="errors.length">
            <p v-for="error in errors" :key="error" class="text-center text-red">
...
export default {
    ...
    data(){
        return {
            ...
            errors: [],
            errorMap: {
                'non_field_errors: Unable to log in with provided credentials.': 'No fue posible iniciar sesion con este usuario y contraseña.',
                'password: This field may not be blank.': 'La contraseña no puede estar vacia.',
                'username: This field may not be blank.': 'El usuario no puede estar vacio.',
            }
        }
    },
    methods:{
